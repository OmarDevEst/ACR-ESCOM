...
#define NP 1000// Numero de producciones (por cada productor)
#define PRO 3  // Numero de productores
#define CON 4  // Numero de consumidores
...
void *prod_thread(void *arg)
{
    ...
    printf("Productor %d: Termine mi trabajo\n", id_producer);
    pthread_exit(NULL);
}
...
void *cons_thread(void *arg)
{
            ...
            if (val > 0)
            {
                ...
                switch (buffer[j]) // Escribir en archivos de texto
                {
                    ...
                    case 4444:
                        ...
                        break;
                    default:
                        printf("Consumidor %d: Hubo un error al momento de consumir\n", id_consumer);
                        break;
                }
                buffer[j] = -1;
    ...
    printf("Consumidor %d: Termine mi trabajo\n", id_consumer);
    pthread_exit(NULL);
}
